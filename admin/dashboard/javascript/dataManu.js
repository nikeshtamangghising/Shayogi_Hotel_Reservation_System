...
// Delete User Function
 ...
 // Attach event listener to edit button
  $(document).on('click', '.edit-button', function () {
    ...
    let disWin = document.getElementById('Add_User');
    let editBtn = document.getElementById('edit_User');
    let addBtn = document.getElementById('add_User');
    editBtn.style.display = 'flex';
    addBtn.style.display = 'none';
    disWin.style.display = 'flex';
    disWin.style.zIndex = '20';
    ...
    if (Name == null || Name == '') {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          $('#add_User').show();
          $('#edit_User').hide();
          $('#Add_User').css('display', 'none').css('z-index', -1);
        }
      });
      $('#add_LoginUser')[0].reset();
    }
